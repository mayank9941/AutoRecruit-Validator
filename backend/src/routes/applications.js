...
// GET /api/jobs/:jobId/imports/:batchId/status — Poll import batch per-row progress
router.get(
  '/jobs/:jobId/imports/:batchId/status',
  authenticate,
  validateParams(importStatusParamsSchema),
  applicationController.getImportStatus
);
